        ...
        Button(action: action) {
            VStack(spacing: 8) {
                ZStack {
                    Circle()
                        .fill(buttonColor)
                        .frame(width: 80, height: 80) // Increase the button size
                        .shadow(radius: 5)
                    
                    Image(systemName: buttonIcon)
                        .font(.system(size: 32, weight: .bold)) // Make the icon larger and bold
...
struct ConvAIView_Previews: PreviewProvider {
